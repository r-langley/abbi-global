        ...
        <div className="container mx-auto px-6 py-12 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg font-medium">Skin Analysis Results</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Your AI skin analysis evaluates eight critical concerns—wrinkles, blemishes, sensitivity, spots,
                      radiance, hydration, sebum control, and pores—tailored to your age and gender to provide precise
                      insights for your skincare journey.
                    </p>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex gap-2">
                        ...
                        <span>
                          <strong>Sebum Regulation (Shine)</strong> - 78% - Your skin shows high oil production that may
                          benefit from mattifying products.
                        </span>
                      </li>
                      <li className="flex gap-2">
                        <span className="text-foreground">•</span>
                        <span>
                          <strong>Radiance</strong> - 44% - Your skin's natural glow could use enhancement with
                          brightening actives.
                        </span>
                      </li>
                      <li className="flex gap-2">
                        <span className="text-foreground">•</span>
                        <span>
                          <strong>Hydration</strong> - 24% - Your skin needs more moisture retention for optimal health.
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-medium mb-2">Soothing Cleansing Foam</h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      This gentle cleansing foam is designed for normal to sensitive skin. Its soft, non-irritating
                      agents effectively cleanse while enhancing skin softness and glow. Key ingredients: Bisabolol to
                      soothe, Papain to regenerate and revive radiance, and Prickly Pear extract to calm irritation and
                      moisturize.
                    </p>
                  </div>
                </CardContent>
