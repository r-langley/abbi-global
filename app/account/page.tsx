              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="mb-1 text-base">Time for your monthly scan</p>
              ...
              <CardContent className="p-5 flex flex-col flex-1">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-muted-foreground text-base">My Skin</p>
                  </div>
              ...
              <CardContent className="p-5 flex flex-col flex-1">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-muted-foreground text-base">Orders</p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-base">{latestOrder.orderNumber}</span>
                ...
                <CardContent className="p-5 flex flex-col flex-1">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-muted-foreground text-base">Subscriptions</p>
                    </div>
                    <svg className="w-4 h-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  ...
                  <div className="flex flex-col flex-1 justify-center gap-3">
                    <div>
                      <p className="mb-1 text-base">Renews {nextRenewal.date}</p>
                    ...
                    <div key={item.step} className={`flex gap-4 p-4 rounded-lg ${item.owned ? "bg-muted/30" : "border border-dashed border-muted-foreground/20"}`}>
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between gap-3 mb-2">
                          <div className="flex-1">
                            <div className="flex gap-2 mb-1 flex-col items-start">
                            ...
                            {item.owned && item.source && (
                              <span className="text-muted-foreground text-sm">via {item.source}</span>
                            )}
                          </div>
                          {!item.owned && (
