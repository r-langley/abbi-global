        ...
        >
          ...
          >
            <CardContent className="p-5">
              ...
              {subscription.hasNewRecommendation && subscription.recommendedSwap && (
                <div className="bg-primary/5 rounded-md p-3 mt-3">
                  <div className="flex items-center gap-1.5 mb-1">
                    ...
                    <span className="text-xs font-medium text-primary">New recommendation</span>
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Swap <span className="font-medium text-foreground">{subscription.recommendedSwap.current}</span> for{" "}
                    <span className="font-medium text-foreground">{subscription.recommendedSwap.suggested}</span>
                  </p>
                </div>
              )}
            </CardContent>
